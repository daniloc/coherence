...
import { buildSceneModel, deriveGates, deriveLight, readLayout, mergeSceneDiff, diffTally, deriveBaseModel, symbolSetsByFile, outsideTally, graphPaths, deriveOutside, fileStats } from "../src/scene.ts";
import type { DiffEnd, FileStat } from "../src/scene.ts";
